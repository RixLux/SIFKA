    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'category' => $this->relationLoaded('category') ? [
                ...
                'icon_marker' => $this->category->icon_marker,
            ...
            'building' => $this->relationLoaded('building') ? [
                ...
                'coordinate' => [
                    'lat' => $this->building->location instanceof Expression
                        ? 0
                        : (float) ($this->building->location->latitude ?? 0),
                    'lng' => $this->building->location instanceof Expression
                        ? 0
                        : (float) ($this->building->location->longitude ?? 0),
                ],
            ] : null,
        ];
    }
